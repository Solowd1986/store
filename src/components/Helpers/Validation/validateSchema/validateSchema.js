...
const validationSchemaFields = [
    ...
    {
        phone: yup.string().required('Данное поле обязательно').min(18, 'Телефон должен включать не менее 11 символов').max(18, 'Телефон должен включать не более 11 символов'),
    },
    {
