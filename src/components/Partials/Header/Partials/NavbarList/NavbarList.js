                        ...
                        <li className={styles.header__inner_item}>
                            <NavLink to="/category/gadgets" className={styles.header__inner_link}>
                                <svg viewBox="0 0 24 24" width={32} height={32}>
                                    <path d="M2 7h5V5H1c-.6 0-1 .4-1 1v12c0 .6.4 1 1 1h8v-2H2V7zm21 0h-1V6c0-.6-.4-1-1-1h-6v2h5v2h2v6h-2v2h-7v2h8c.6 0 1-.4 1-1v-1h1c.6 0 1-.4 1-1V8c0-.6-.4-1-1-1z" />
                                    <path d="M16 9h-2V6c0-.6-.4-1-1-1s-1 .4-1 1v3h-2V6c0-.6-.4-1-1-1s-1 .4-1 1v3H6c0 2.4 1.7 4.4 4 4.9V18c0 .6.4 1 1 1s1-.4 1-1v-4.1c2.3-.5 4-2.5 4-4.9zm-5 4c-1.9 0-3.4-1.3-3.9-3h7.7c-.4 1.7-1.9 3-3.8 3z" />
                                </svg>
