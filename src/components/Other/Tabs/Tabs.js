        ...
        return (
            <ul className={styles.list} ref={this.refList}>
                <li className={styles.item}>
                    <span className={classNames(styles.title)} onClick={this.open}>Item 1</span>
                ...
                <li className={styles.item}>
                    <span className={styles.title} onClick={this.open}>Item 2</span>
                ...
                <li className={styles.item}>
                    <span className={styles.title} onClick={this.open}>Item 3</span>
                    <p className={styles.content}>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam aliquid cumque
                        ducimus, eius ex fugiat ipsa ipsam libero maxime minus nihil nostrum officia pariatur
                        placeat quasi qui quia repellat voluptas.
                ...
                <li className={styles.item}>
                    <span className={styles.title} onClick={this.open}>Item 4</span>
                    <p className={styles.content}>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam aliquid cumque
                        ducimus, eius ex fugiat ipsa ipsam libero maxime minus nihil nostrum officia pariatur
                        placeat quasi qui quia repellat voluptas.
