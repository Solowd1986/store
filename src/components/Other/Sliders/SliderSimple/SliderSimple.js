    ...
    render() {
        return (
            <>
                ...
                <div data-list={true}>
                    <img className={classNames(styles.slide, styles.active_slide)} src="https://fakeimg.pl/200x200/282828/?text=IMG1" alt="generic_img"/>
                    <img className={classNames(styles.slide)} src="https://fakeimg.pl/200x200/282828/?text=IMG2" alt="generic_img"/>
                    <img className={classNames(styles.slide)} src="https://fakeimg.pl/200x200/282828/?text=IMG3" alt="generic_img"/>
                    <img className={classNames(styles.slide)} src="https://fakeimg.pl/200x200/282828/?text=IMG4" alt="generic_img"/>
                </div>
