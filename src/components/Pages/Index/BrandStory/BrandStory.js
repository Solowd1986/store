        ...
        <section className={styles.brand_story}>
            <div className={`${styles.brand_story__item} ${styles.milestone_item}`}>
                <div className={styles.brand_story__info}>
                    <h2 className={styles.brand_story__title}>Новые <br/> вершины</h2>
                    <div className={styles.brand_story__text_slide}>
                        <h4 className={styles.brand_story__subtitle}>Завораживающий <br/> 90 Гц экран</h4>
                        ...
                        <a className={styles.brand_story__link} href="/">Узнать больше...</a>
                    </div>
                </div>
            </div>
            <div className={`${styles.brand_story__item} ${styles.achivments_item}`}>
                <div className={styles.brand_story__info}>
                    <h2 className={styles.brand_story__title}>Достижения <br/> компании</h2>
                    <div className={styles.brand_story__text_slide}>
                        <h4 className={styles.brand_story__subtitle}>Игровой режим <br/> «Fnatic Mode»</h4>
                        <p className={styles.brand_story__desc}>
            ...
            <div className={`${styles.brand_story__item} ${styles.our_people_item}`}>
                <div className={styles.brand_story__info}>
                    <h2 className={styles.brand_story__title}>Наше <br/> сообщество</h2>
                    <div className={styles.brand_story__text_slide}>
                        <h4 className={styles.brand_story__subtitle}>Создаем наши устройства <br/>вместе с вами!</h4>
                        <p className={styles.brand_story__desc}>
