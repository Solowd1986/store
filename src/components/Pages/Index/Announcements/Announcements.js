        ...
        <ul className={styles.announcements__list}>
          <li>
            ...
            <div className={styles.text_wrapper}>
              ...
              <p>
                <a href="#">
                  Пользователи OnePlus 8 и OnePlus 8 Pro теперь могут опробовать Android 11 Developer Preview 3 и
                  впервые ознакомиться с обновленным дизайном и функциями OxygenOS 11.
                </a>
              </p>
            ...
            <div className={styles.text_wrapper}>
              ...
              <p>
                <a href="#">
                  ...
                  прослушивания, отличаются потрясающим временем автономной работы и быстрой зарядкой, отличным
                  качеством звука с глубокими басами и удобным дизайном с простотой использования для всех
                  пользователей.
                </a>
              </p>
              <a className={styles.text_wrapper__link_details} href="#">
