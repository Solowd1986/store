    ...
    return (
      <>
        ...
        <div className={cn("wrapper", styles.delivery_wrapper)}>
          ...
          <p>
            Доставим Вам товар в день заказа, при его оформлении до 14:00, в ином случае, оператор сообщит Вам о
            ближайшем возможном времени доставки.
          </p>
          <p>Стоимость услуги «В пределах МКАД», составляет 290 рублей, от 6000р. - бесплатно.</p>
          <p>
            Обратите внимание, передача курьером товара для проверки осуществляется только после оплаты. Оплата курьеру
            наличными.
          </p>
          ...
          <p>
            Вы можете воспользоваться услугами CDEK, PickPoint и BoxBerry. Вариативность позволит Вам выбрать либо
            курьерскую доставку до двери, либо доставку до пункта самовывоза выбранной Вами ТК.
          </p>
